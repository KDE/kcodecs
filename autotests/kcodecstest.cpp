...
void KCodecsTest::testRFC2047decode()
{
    ...
    // utf-8
    QCOMPARE(KCodecs::decodeRFC2047String("=?utf-8?q?Ingo=20Kl=C3=B6cker?= <kloecker@kde.org>", "utf-8"),
             QString::fromUtf8("Ingo Klöcker <kloecker@kde.org>"));
    QCOMPARE(KCodecs::decodeRFC2047String("=?utf-8?q?Ingo=20Kl=C3=B6cker?="),
    ...
    */
    ...
    // iso-8859-x
    QCOMPARE(KCodecs::decodeRFC2047String("=?ISO-8859-1?Q?Andr=E9s_Ot=F3n?=", "utf-8"),
             QString::fromUtf8("Andrés Otón"));
    QCOMPARE(KCodecs::decodeRFC2047String("=?iso-8859-2?q?Rafa=B3_Rzepecki?=", "utf-8"),
             QString::fromUtf8("Rafał Rzepecki"));
    QCOMPARE(KCodecs::decodeRFC2047String("=?iso-8859-9?Q?S=2E=C7a=F0lar?= Onur", "utf-8"),
             QString::fromUtf8("S.Çağlar Onur"));
    QCOMPARE(KCodecs::decodeRFC2047String("Rafael =?iso-8859-15?q?Rodr=EDguez?=", "utf-8"),
             QString::fromUtf8("Rafael Rodríguez"));

    // language parameter according to RFC 2231, section 5
    QCOMPARE(KCodecs::decodeRFC2047String("From: =?US-ASCII*EN?Q?Keith_Moore?= <moore@cs.utk.edu>"),
    ...
    QCOMPARE(KCodecs::decodeRFC2047String("Subject: =?iso-8859-1?Q?ÖÄÜöäü?="),
