...
void RFC2047Test::testRFC2047encode_data()
{
    ...
    QTest::newRow("working-QP") << u"Ingo Klöcker <kloecker@kde.org>"_s << "ISO-8859-15"_ba << "Ingo =?ISO-8859-15?Q?Kl=F6cker_=3Ckloecker=40kde=2Eorg=3E?="_ba
                                << KCodecs::RFC2047EncodingOption::EncodeReserverdCharcters;
    ...
    QTest::newRow("reserved-chars-2") << u"\"n@o\""_s << "utf-8"_ba << "=?utf-8?B?Im5AbyI=?="_ba << KCodecs::RFC2047EncodingOption::EncodeReserverdCharcters;
}
